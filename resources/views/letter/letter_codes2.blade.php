     ...
     <div class='modal-content'>
       ...
       <div class='modal-body'>
            <form id='add_letter_template'>
                    ...
                    <input placeholder='enter letter subject .....' name='subject' id="add_template_letter_subject" class="form-control form-control-sm mt-2 mb-2" >

                    <input name='body_part_1' value='paragraph' hidden>
                    <strong>Letter Body</strong><br/>
                    <textarea class="form-control form-control-sm mt-2 mb-2" name="paragraph_1" placeholder="write some content here.."></textarea>
                    ...
                    <table class="mt-4 mb-2">
                            <tr>
                                ...
                                <td style='padding-left:20px;'>
                                    <a onclick='$("#add_table_form").toggle(500)' class='btn btn-sm btn-outline-dark'>add table</a>
                                </td>
                                <td style='padding-left:15px;display:none' id='add_table_form'>
                                    <div style='border:1px solid gray;border-radius:5px;'>
                                        <table>
                                            <tr>
                                                <td>
                                                    <select id='row_selector' class='form-control form-control-sm'>
                                                ...
                                                <td>
                                                    <select id='column_selector' class='form-control form-control-sm'>
                                                ...
                                                <td style='width:1px;background-color:lightgray'></td>
                                                <td>
                                                    <a onclick='add_template_table()' class='btn btn-sm btn-primary'>add</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                    ...
                    <input name='closure' placeholder='enter letter closure .....' id="add_template_letter_closure" class="form-control form-control-sm mt-2 mb-2" >
