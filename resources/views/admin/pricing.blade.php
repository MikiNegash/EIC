            ...
            <div class="container-fluid">
                ...
                <div class="row mb-5">
                    <div class="col-xl-12">
                        ...
                        <p class="text-muted text-center">Choose plan that suits best for your business needs, Our plans
                            scales with you based on your needs</p>
                        <div class="d-flex justify-content-center mb-4">
                            <ul class="nav nav-tabs mb-3 tab-style-6 bg-primary-transparent" id="myTab1" role="tablist">
                                <li class="nav-item" role="presentation"> <button class="nav-link active"
                                        id="pricing-monthly1" data-bs-toggle="tab"
                                ...
                                <li class="nav-item" role="presentation"> <button class="nav-link" id="pricing-yearly1"
                                        data-bs-toggle="tab" data-bs-target="#pricing-yearly1-pane" type="button"
                                        role="tab" aria-controls="pricing-yearly1-pane"
                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <div class="p-4">
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                                        ...
                                                        <div> <span class="badge bg-success-transparent">For
                                                                Indivudials</span> </div>
                                                    </div>
                                                    <div class="fs-25 fw-bold mb-1">$0<sub
                                                            class="text-muted fw-semibold fs-11 ms-1">/ Per Month</sub>
                                                    </div>
                                                    ...
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                                            </span> <span> <strong class="me-1">2 Free</strong>Websites
                                                            </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                                            </span> <span> <strong class="me-1">1 GB</strong>Hard disk
                                                                storage </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-muted op-3"></i>
                                                            </span> <span> <strong class="me-1">1 Year</strong>Email
                                                                support </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-muted op-3"></i>
                                                            </span> <span> <strong class="me-1">2</strong>Licenses
                                                            </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-muted op-3"></i>
                                                            </span> <span> Custom SEO optimizataion </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-muted op-3"></i>
                                                            </span> <span> Chat Support </span> </li>
                                                        <li class="d-grid"> <button
                                                                class="btn btn-light btn-wave">Choose Plan</button>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <div class="p-4">
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                                        ...
                                                        <div> <span class="badge bg-success-transparent"> For Small
                                                                Teams </span> </div>
                                                    </div>
                                                    ...
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                                            </span> <span> <strong class="me-1">5 Free</strong>Websites
                                                            </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                                            </span> <span> <strong class="me-1">5 GB</strong>Hard disk
                                                                storage </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                                            </span> <span> <strong class="me-1">2 Years</strong>Email
                                                                support </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                                            </span> <span> <strong class="me-1">5</strong>Licenses
                                                            </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-muted op-3"></i>
                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <div class="p-4">
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                                        ...
                                                        <div> <span class="badge bg-primary-transparent"> For Business
                                                                Purpose </span> </div>
                                                    </div>
                                                    ...
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                                            </span> <span> <strong class="me-1">10 Free</strong>Websites
                                                            </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                                            </span> <span> <strong class="me-1">20 GB</strong>Hard disk
                                                                storage </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                                            </span> <span> <strong class="me-1">3 Years</strong>Email
                                                                support </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                                            </span> <span> <strong class="me-1">15</strong>Licenses
                                                            </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                                        ...
                                                        <li class="d-grid"> <button
                                                                class="btn btn-primary btn-wave">Choose Plan</button>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <div class="p-4">
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                                        ...
                                                        <div> <span class="badge bg-success-transparent"> For Large
                                                                Companies </span> </div>
                                                    </div>
                                                    <div class="fs-25 fw-bold mb-1">$7,999<sub
                                                            class="text-muted fw-semibold fs-11 ms-1">/ Per Month</sub>
                                                    </div>
                                                    <div class="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur
                                                        adipisicing elit. Iure quos debitis aliquam .</div>
                                                    ...
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                                            </span> <span> <strong class="me-1">20 Free</strong>Websites
                                                            </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                                            </span> <span> <strong class="me-1">30 GB</strong>Hard disk
                                                                storage </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                                            </span> <span> <strong class="me-1">5 Year</strong>Email
                                                                support </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                                            </span> <span> <strong class="me-1">50</strong>Licenses
                                                            </span> </li>
                                                        <li class="d-flex align-items-center mb-3"> <span class="me-2">
                                                                <i
                                                                    class="ri-checkbox-circle-line fs-15 text-success"></i>
                                        ...
                                        <div class="card custom-card overflow-hidden">
                                            <div class="card-body p-0">
                                                ...
                                                <div class="p-4">
                                                    ...
                                                    <div class="fs-25 fw-bold mb-1">$1,799<sub
                                                            class="text-muted fw-semibold fs-11 ms-1">/ Per Month</sub>
                                                    </div>
                                                    <div class="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur
                                                        adipisicing elit. Iure quos debitis aliquam .</div>
                                        ...
                                        <div class="card custom-card overflow-hidden border border-primary">
                                            <div class="card-body p-0">
                                                ...
                                                <div class="p-4">
                                                    ...
                                                    <div class="fs-25 fw-bold mb-1">$11,999<sub
                                                            class="text-muted fw-semibold fs-11 ms-1">/ Per Month</sub>
                                                    </div>
                                                    <div class="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur
                                                        adipisicing elit. Iure quos debitis aliquam .</div>
                                        ...
                                        <div class="card custom-card overflow-hidden">
                                            <div class="card-body p-0">
                                                ...
                                                <div class="p-4">
                                                    ...
                                                    <div class="fs-25 fw-bold mb-1">$83,999<sub
                                                            class="text-muted fw-semibold fs-11 ms-1">/ Per Month</sub>
                                                    </div>
                                                    <div class="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur
                                                        adipisicing elit. Iure quos debitis aliquam .</div>
                    ...
                    <div class="col-xxl-8 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="container-lg">
                            <div class="row justify-content-center">
                                <div class="col-xl-9">
                                    <h5 class="fw-semibold text-center"> Simple Pricing For Everyone </h5>
                                    <p class="text-muted text-center">Choose plan that suits best for your business
                                        needs, Our plans scales with you based on your needs</p>
                                </div>
                            </div>
                            <div class="d-flex justify-content-center mb-4">
                                <ul class="nav nav-tabs mb-3 tab-style-6 bg-primary-transparent" id="myTab"
                                    role="tablist">
                                    <li class="nav-item" role="presentation"> <button class="nav-link active"
                                            id="pricing-monthly" data-bs-toggle="tab"
                                    ...
                                    <li class="nav-item" role="presentation"> <button class="nav-link"
                                            id="pricing-yearly" data-bs-toggle="tab"
                                        ...
                                        <div class="tab-pane show active p-0 border-bottom-0" id="pricing-monthly-pane"
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="p-4">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="text-end ms-5">
                                                                ...
                                                                <p class="text-muted op-5 fs-11 fw-semibold mb-0">per
                                                                    month</p>
                                                            </div>
                                                        </div>
                                                        <ul class="list-unstyled text-center fs-12 px-3 pt-3 mb-0">
                                                            <li class="mb-3"> <span class="text-muted">Storage
                                                                    Capacity<span
                                                                        class="badge bg-light text-default ms-1">1Tb</span></span>
                                                            </li>
                                                            <li class="mb-3"> <span class="text-muted">Daily
                                                                    Updates<span
                                                                        class="badge bg-light text-default ms-1">Unlimited</span></span>
                                                            </li>
                                                            <li class="mb-3"> <span class="text-muted">Online
                                                                    Support</span> </li>
                                                            <li class="mb-3"> <span class="text-muted">Visitors
                                                                    Monitoring<span
                                                                        class="badge bg-light text-default ms-1">24/7</span></span>
                                                            </li>
                                                            <li class="mb-3"> <span class="text-muted">2 Free
                                                                    Domains</span> </li>
                                                            <li class="mb-4"> <span class="text-muted">Money Back
                                                                    Guarentee</span> </li>
                                                        </ul>
                                                        <div class="d-grid"> <button
                                                                class="btn btn-primary-light btn-wave">Get
                                                                Started</button> </div>
                                                    </div>
                                                </div>
                                                <div
                                                    class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 border-end border-inline-end-dashed px-0">
                                                    <div class="p-4">
                                                        ...
                                                        <ul class="list-unstyled text-center fs-12 px-3 pt-3 mb-0">
                                                            ...
                                                            <li class="mb-3"> <span class="text-muted">10 Free
                                                                    Domains</span> </li>
                                                            <li class="mb-4"> <span class="text-muted">Money Back
                                                                    Guarentee</span> </li>
                                                        </ul>
                                                ...
                                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 ps-0">
                                                    <div class="p-4 pricing-offer overflow-hidden"> <span
                                                            class="pricing-offer-details shadow"> <span
                                                                class="fw-semibold">10%</span> <span
                                                                class="fs-10 op-8 ms-1">Off</span> </span>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="text-end ms-5">
                                                                <p class="fs-25 fw-semibold mb-0 text-primary">$1,299
                                                                </p>
                                                                <p class="text-muted op-5 fs-11 fw-semibold mb-0">per
                                                                    month</p>
                                                            </div>
                                                        ...
                                                        <ul class="list-unstyled text-center fs-12 px-3 pt-3 mb-0">
                                                            ...
                                                            <li class="mb-3"> <span class="text-muted">30 Free
                                                                    Domains</span> </li>
                                                            <li class="mb-4"> <span class="text-muted">Money Back
                                                                    Guarentee</span> </li>
                                                        </ul>
                                                        <div class="d-grid"> <button
                                                                class="btn btn-primary btn-wave">Get Started</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 ps-0">
                                                    <div class="p-4 pricing-offer overflow-hidden"> <span
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="text-end ms-5">
                                                                <p class="fs-25 fw-semibold mb-0 text-primary">$11,499
                                                                </p>
                                                                <p class="text-muted op-5 fs-11 fw-semibold mb-0">per
                                                                    month</p>
                                                            </div>
                        ...
                        <div class="container-lg">
                            <div class="row justify-content-center">
                                <div class="col-xl-9">
                                    ...
                                    <p class="text-muted text-center mb-4">Select best plans that fits your needs for
                                        your business growth,plans are flexible with the enterprise.Familiarize with the
                                        payment plans below</p>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered text-nowrap">
                                            <thead>
                                                <tr>
                                                    <th scope="col"> <span class="fs-15 fw-semibold">Chek Our
                                                            Plans</span> </th>
                                                    <th scope="col" class="pricing-basic"> <span
                                                            class="fs-15 fw-semibold">Basic</span> </th>
                                                    <th scope="col" class="pricing-pro"> <span
                                                            class="fs-15 fw-semibold">Pro</span> </th>
                                                    <th scope="col" class="pricing-premium"> <span
                                                            class="fs-15 fw-semibold">Premium</span> </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr class="text-center bg-light">
                                                    <td colspan="4"> <span class="fs-14 fw-semibold">Main
                                                            Features</span> </td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td> <span> 24/7 support <span class="badge bg-primary ms-2">1
                                                                Year</span> </span> </td>
                                                    <td> <span> 24/7 support <span class="badge bg-primary ms-2">5
                                                                Year</span> </span> </td>
                                                    <td> <span> 24/7 support <span class="badge bg-primary ms-2">Life
                                                                Long</span> </span> </td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td> <span> Storage Capacity <span class="badge bg-success ms-2">1
                                                                TB</span> </span> </td>
                                                    <td> <span> Storage Capacity <span class="badge bg-success ms-2">5
                                                                TB</span> </span> </td>
                                                    <td> <span> Storage Capacity <span class="badge bg-success ms-2">10
                                                                TB</span> </span> </td>
                                                </tr>
                                                <tr class="text-center bg-light">
                                                    <td colspan="4"> <span class="fs-14 fw-semibold">Complete
                                                            Features</span> </td>
                                                </tr>
                                                <tr>
                                                    <td> <span class="fw-bold fs-14"> Domains </span> </td>
                                                    <td> <span class="fw-semibold">2 Free</span> Domain names </td>
                                                    <td> <span class="fw-semibold">5 Free</span> Domain names </td>
                                                    <td> <span class="fw-semibold">10 Free</span> Domain names </td>
                                                </tr>
                                                <tr>
                                                    <td> <span class="fw-bold fs-14"> Money Back Guarentee </span> </td>
                                                    <td> <span
                                                ...
                                                <tr>
                                                    <td> <span class="fw-bold fs-14"> App Integrations </span> </td>
                                                    <td> <span
                                                ...
                                                <tr>
                                                    <td> <span class="fw-bold fs-14"> Future Updates </span> </td>
                                                    <td> <span
                                                            class="badge bg-danger-transparent p-1 lh-1 rounded-circle">
                                                            <i class="ri-close-line align-middle fw-semibold"></i>
                                                        </span> </td>
                                                ...
                                                <tr>
                                                    <td> <span class="fw-bold fs-14"> Team Management </span> </td>
                                                    <td> <span
                                                            class="badge bg-danger-transparent p-1 lh-1 rounded-circle">
                                                            <i class="ri-close-line align-middle fw-semibold"></i>
                                                        </span> </td>
                                                ...
                                                <tr>
                                                    <td> <span class="fw-bold fs-14"> Customer Support </span> </td>
                                                    <td> <span
                                                            class="badge bg-danger-transparent p-1 lh-1 rounded-circle">
                                                            <i class="ri-close-line align-middle fw-semibold"></i>
                                                        </span> </td>
                                                ...
                                                <tr class="text-center bg-light">
                                                    <td colspan="4"> <span class="fs-14 fw-semibold">Pricing</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row"> <span class="fw-bold fs-14">Net Price</span> </th>
                                                    <td> <span class="fs-18 fw-semibold text-dark">$99</span> </td>
                                                    <td> <span class="fs-18 fw-semibold text-dark">$299</span> </td>
                                                    <td> <span class="fs-18 fw-semibold text-dark">$499</span> </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row"> <span class="fw-bold fs-14">Annual
                                                            Subscription</span> </th>
                                                    <td> <span class="fs-18 fw-semibold text-dark">$1,199</span> </td>
                                                    <td> <span class="fs-18 fw-semibold text-dark">$3,499</span> </td>
                                                    <td> <span class="fs-18 fw-semibold text-dark">$5,499</span> </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row"> <span class="fw-bold fs-14">Activation
                                                            Charges</span> </th>
                                                    <td> <span class="fw-semibold">0% + $99</span> </td>
                                                    <td> <span class="fw-semibold">5% + $149</span> </td>
                                                    <td> <span class="fw-semibold">10% + $259</span> </td>
                                                </tr>
                                                <tr>
                                                    <td class="border-bottom-0"></td>
                                                    <td class="border-bottom-0"> <button
                                                            class="btn btn-primary btn-wave">Choose Plan</button> </td>
                                                    <td class="border-bottom-0"> <button
                                                            class="btn btn-primary btn-wave">Choose Plan</button> </td>
                                                    <td class="border-bottom-0"> <button
                                                            class="btn btn-primary btn-wave">Choose Plan</button> </td>
