        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="alert alert-solid-secondary alert-dismissible fs-15 fade show mb-4"> We Placed <strong
                        class="text-fixed-black">Datatables</strong> only in this page by using <strong
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <table id="responsiveDataTable" class="table table-bordered text-nowrap"
                                    style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>First name</th>
                            ...
                            <div class="card-body">
                                <div class="deleted-table table-responsive">
                                    <div class="text-center"> <button id="button"
                                            class="btn btn-primary mb-2 data-table-btn">Delete selected row</button>
                                    </div>
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div class="text-center"> <button id="addRow"
                                            class="btn btn-primary mb-2 data-table-btn">Add new row</button> </div>
