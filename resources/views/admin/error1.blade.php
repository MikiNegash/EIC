...
<body>
                ...
                <div class="text-center p-5 my-auto">
                    <div class="row align-items-center justify-content-center h-100">
                        <div class="col-xl-7">
                            ...
                            </div> <a href="dashboard1" class="btn btn-primary"><i
    ...
    <script src="../assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script> <!-- Particles JS -->
    <script src="../assets/libs/particles.js/particles.js"></script> <!-- Error JS -->
