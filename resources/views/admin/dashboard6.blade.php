...
<body>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-xl-7">
                        <div class="row">
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                                            <div>
                                                <h6 class="fw-semibold mb-3">Total Users</h6> <span
                                                    class="fs-25 fw-semibold">9,789</span> <span
                                                    class="d-block text-success fs-12">+0.892 <i
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div>
                                                <h6 class="fw-semibold mb-3">Live Visitors</h6> <span
                                                    class="fs-25 fw-semibold">12,240</span> <span
                                                    class="d-block text-danger fs-12">+0.59<i
                                                        class="ti ti-trending-down ms-1 d-inline-flex"></i></span>
                                            </div>
                                            <div> <span class="avatar avatar-md bg-secondary"> <i
                                                        class="ri-user-3-line"></i> </span> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                <div class="card custom-card overflow-hidden">
                                    <div class="card-body mb-3">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div>
                                                <h6 class="fw-semibold text-primary mb-3">Bounce Rate</h6> <span
                                                    class="fs-25 d-flex align-items-center">77.3% <span
                            ...
                            <div class="col-xl-12">
                                <div class="card custom-card">
                                    <div class="card-header justify-content-between">
                                        <div class="card-title"> Audience Report </div>
                                        <div> <button type="button" class="btn btn-primary-light btn-wave"><i
                            ...
                            <div class="col-xxl-6 col-xl-12">
                                <div class="card custom-card">
                                    <div class="card-header justify-content-between">
                                        <div class="card-title"> Top Countries Sessions vs Bounce Rate </div>
                                        <div class="dropdown"> <a href="javascript:void(0);"
                                                class="p-2 fs-12 text-muted" data-bs-toggle="dropdown"> View All<i
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center"> <span
                                                                    class="avatar avatar-rounded avatar-sm p-2 bg-light me-2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="progress progress-xs">
                                                                <div class="progress-bar bg-primary" role="progressbar"
                                                                    style="width: 32%" aria-valuenow="32"
                                                                    aria-valuemin="0" aria-valuemax="100"> </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td> <span><i
                                                                    class="ri-arrow-down-s-fill me-1 text-danger align-middle fs-18"></i>12,457</span>
                                                        </td>
                                                        <td>
                                                            <div class="progress progress-xs">
                                                                <div class="progress-bar bg-primary" role="progressbar"
                                                                    style="width: 21%" aria-valuenow="21"
                                                                    aria-valuemin="0" aria-valuemax="100"> </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center"> <span
                                                                    class="avatar avatar-rounded avatar-sm p-2 bg-light me-2">
                                                                    <i class="ri-edge-fill fs-18 text-info"></i> </span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <span><i
                                                                    class="ri-arrow-down-s-fill me-1 text-danger align-middle fs-18"></i>6,135</span>
                                                        </td>
                                                        <td>
                                                            <div class="progress progress-xs">
                                                                <div class="progress-bar bg-primary" role="progressbar"
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12">
                                        <div class="card custom-card upgrade-card text-fixed-white">
                                            <div class="card-body text-fixed-white"> <span class="avatar avatar-xxl">
                                                    <img src="../assets/images/media/media-84.png" alt=""> </span>
                                                <div class="upgrade-card-content"> <span
                                                        class="op-7 fw-normal mb-1">Plan is expiring !</span> <span
                                                        class="fs-15 fw-semibold d-block mb-5 upgrade-text">Upgrade to
                                                        premium</span> <button type="button"
                                                        class="btn btn-sm btn-light btn-wave">Upgrade Now</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xxl-7 col-xl-12">
                                <div class="card custom-card">
                                    <div class="card-header justify-content-between">
                                        ...
                                        <div> <button type="button" class="btn btn-primary-light">View All</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-footer p-0">
                                        <div class="row row-cols-12 justify-content-center">
                                            <div class="col pe-0 text-center">
                                                <div class="p-sm-3 p-2 "> <span class="text-muted fs-11">Mobile</span>
                                                    <span class="d-block fs-16 fw-semibold">68.3%</span> </div>
                                            </div>
                                            <div class="col px-0 text-center">
                                                <div class="p-sm-3 p-2 "> <span class="text-muted fs-11">Tablet</span>
                                                    <span class="d-block fs-16 fw-semibold">17.68%</span> </div>
                                            </div>
                                            <div class="col px-0 text-center">
                                                <div class="p-sm-3 p-2 "> <span class="text-muted fs-11">Desktop</span>
                                                    <span class="d-block fs-16 fw-semibold">10.5%</span> </div>
                                            </div>
                                            <div class="col px-0 text-center">
                                                <div class="p-sm-3 p-2"> <span class="text-muted fs-11">Others</span>
                                                    <span class="d-block fs-16 fw-semibold">5.16%</span> </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-xl-9">
                        <div class="card custom-card">
                            <div class="card-header justify-content-between">
                                <div class="card-title"> Visitors By Channel Report </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center"> <span
                                                        ...
                                                        </span> <span class="ms-2"> Organic Search </span> </div>
                                                </td>
                                                <td>782</td>
                                                <td>32.09%</td>
                                                <td> 0 hrs : 0 mins : 32 secs </td>
                                                <td> <span class="badge bg-primary-transparent">278</span> </td>
                                                <td> 2.9 </td>
                                            </tr>
                                            <tr>
                                                <th scope="row"> 2 </th>
                                                <td>
                                                    <div class="d-flex align-items-center"> <span
                                                        ...
                                                        </span> <span class="ms-2"> Direct </span> </div>
                                                </td>
                                                <td>882</td>
                                                <td>39.38%</td>
                                                <td> 0 hrs : 2 mins : 45 secs </td>
                                                <td> <span class="badge bg-secondary-transparent">782</span> </td>
                                                <td> 1.5 </td>
                                            </tr>
                                            <tr>
                                                <th scope="row"> 3 </th>
                                                <td>
                                                    <div class="d-flex align-items-center"> <span
                                                            class="avatar avatar-sm bg-success-transparent avatar-rounded">
                                                            <i
                                                                class="ri-share-forward-line fs-15 fw-semibiold text-success"></i>
                                                        </span> <span class="ms-2"> Referral </span> </div>
                                                </td>
                                                <td>322</td>
                                                <td>22.67%</td>
                                                <td> 0 hrs : 38 mins : 28 secs </td>
                                                <td> <span class="badge bg-success-transparent">622</span> </td>
                                                <td> 3.2 </td>
                                            </tr>
                                            <tr>
                                                <th scope="row"> 4 </th>
                                                <td>
                                                    <div class="d-flex align-items-center"> <span
                                                            class="avatar avatar-sm bg-info-transparent avatar-rounded">
                                                            <i class="ri-reactjs-line fs-15 fw-semibiold text-info"></i>
                                                        </span> <span class="ms-2"> Social </span> </div>
                                                </td>
                                                <td>389</td>
                                                <td>25.11%</td>
                                                <td> 0 hrs : 12 mins : 89 secs </td>
                                                <td> <span class="badge bg-info-transparent">142</span> </td>
                                                <td> 1.4 </td>
                                            </tr>
                                            <tr>
                                                <th scope="row"> 5 </th>
                                                <td>
                                                    <div class="d-flex align-items-center"> <span
                                                            class="avatar avatar-sm bg-warning-transparent avatar-rounded">
                                                            <i class="ri-mail-line fs-15 fw-semibiold text-warning"></i>
                                                        </span> <span class="ms-2"> Email </span> </div>
                                                </td>
                                                <td>378</td>
                                                <td>23.79%</td>
                                                <td> 0 hrs : 14 mins : 27 secs </td>
                                                <td> <span class="badge bg-warning-transparent">178</span> </td>
                                                <td> 1.6 </td>
                                            </tr>
                                            <tr>
                                                <th scope="row"> 6 </th>
                                                <td>
                                                    <div class="d-flex align-items-center"> <span
                                                            class="avatar avatar-sm bg-danger-transparent avatar-rounded">
                                                            <i
                                                                class="ri-bank-card-line fs-15 fw-semibiold text-danger"></i>
                                                        </span> <span class="ms-2"> Paid Search </span> </div>
                                                </td>
                                                <td>488</td>
                                                <td>28.77%</td>
                                                <td> 0 hrs : 16 mins : 28 secs </td>
                                                <td> <span class="badge bg-danger-transparent">578</span> </td>
                                                <td> 2.5 </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled mb-0 analytics-visitors-countries">
                                    <li>
                                        <div class="d-flex align-items-center">
                                            <div class="lh-1"> <span
                                                    class="avatar avatar-sm avatar-rounded text-default"> <img
                                                        src="../assets/images/flags/us_flag.jpg" alt=""> </span> </div>
                                            <div class="ms-3 flex-fill lh-1"> <span class="fs-12">United States</span>
                                            </div>
                                            <div> <span
                                                    class="text-default badge bg-light fw-semibold mt-2">32,190</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex align-items-center">
                                            <div class="lh-1"> <span
                                                    class="avatar avatar-sm avatar-rounded text-default"> <img
                                                        src="../assets/images/flags/germany_flag.jpg" alt=""> </span>
                                            </div>
                                            <div class="ms-3 flex-fill lh-1"> <span class="fs-12">Germany</span> </div>
                                            <div> <span
                                                    class="text-default badge bg-light fw-semibold mt-2">8,798</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex align-items-center">
                                            <div class="lh-1"> <span
                                                    class="avatar avatar-sm avatar-rounded text-default"> <img
                                                        src="../assets/images/flags/mexico_flag.jpg" alt=""> </span>
                                            </div>
                                            <div class="ms-3 flex-fill lh-1"> <span class="fs-12">Mexico</span> </div>
                                            <div> <span
                                                    class="text-default badge bg-light fw-semibold mt-2">16,885</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3 flex-fill lh-1"> <span class="fs-12">Uae</span> </div>
                                            <div> <span
                                                    class="text-default badge bg-light fw-semibold mt-2">14,885</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex align-items-center">
                                            <div class="lh-1"> <span
                                                    class="avatar avatar-sm avatar-rounded text-default"> <img
                                                        src="../assets/images/flags/argentina_flag.jpg" alt=""> </span>
                                            </div>
                                            <div class="ms-3 flex-fill lh-1"> <span class="fs-12">Argentina</span>
                                            </div>
                                            <div> <span
                                                    class="text-default badge bg-light fw-semibold mt-2">17,578</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex align-items-center">
                                            <div class="lh-1"> <span
                                                    class="avatar avatar-sm avatar-rounded text-default"> <img
                                                        src="../assets/images/flags/russia_flag.jpg" alt=""> </span>
                                            </div>
                                            <div class="ms-3 flex-fill lh-1"> <span class="fs-12">Russia</span> </div>
                                            <div> <span
                                                    class="text-default badge bg-light fw-semibold mt-2">10,118</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex align-items-center">
                                            <div class="lh-1"> <span
                                                    class="avatar avatar-sm avatar-rounded text-default"> <img
                                                        src="../assets/images/flags/china_flag.jpg" alt=""> </span>
                                            </div>
                                            <div class="ms-3 flex-fill lh-1"> <span class="fs-12">China</span> </div>
                                            <div> <span
                                                    class="text-default badge bg-light fw-semibold mt-2">6,578</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex align-items-center">
                                            <div class="lh-1"> <span
                                                    class="avatar avatar-sm avatar-rounded text-default"> <img
                                                        src="../assets/images/flags/french_flag.jpg" alt=""> </span>
                                            </div>
                                            <div class="ms-3 flex-fill lh-1"> <span class="fs-12">France</span> </div>
                                            <div> <span
                                                    class="text-default badge bg-light fw-semibold mt-2">2,345</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex align-items-center">
                                            <div class="lh-1"> <span
                                                    class="avatar avatar-sm avatar-rounded text-default"> <img
                                                        src="../assets/images/flags/canada_flag.jpg" alt=""> </span>
                                            </div>
                                            <div class="ms-3 flex-fill lh-1"> <span class="fs-12">Canada</span> </div>
                                            <div> <span
                                                    class="text-default badge bg-light fw-semibold mt-2">1,678</span>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
    ...
    <script src="../assets/libs/apexcharts/apexcharts.min.js"></script> <!-- Used For Sessions By Device Chart -->
    <script src="../assets/libs/moment/moment.js"></script> <!-- Analytics-Dashboard JS -->
    <script src="../assets/js/analytics-dashboard.js"></script> <!-- Custom-Switcher JS -->
    <script src="../assets/js/custom-switcher.min.js"></script> <!-- Custom JS -->
    <script src="../assets/js/custom.js"></script>
</body>
<!-- Mirrored from spruko.com/demo/ynex/dist/html/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Jun 2023 07:35:19 GMT -->
