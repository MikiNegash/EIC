                ...
                <div class="row">
                    <div class="col-xl-9">
                        <div class="card custom-card">
                            <div class="card-header d-md-flex d-block">
                                <div class="h5 mb-0 d-sm-flex d-bllock align-items-center">
                                    <div class="avatar avatar-sm"> <img
                                            src="../assets/images/brand-logos/toggle-logo.png" alt=""> </div>
                                    <div class="ms-sm-2 ms-0 mt-sm-0 mt-2">
                                        <div class="h6 fw-semibold mb-0">SHOPPING INVOICE : <span
                                                class="text-primary">#8140-2099</span></div>
                                    </div>
                                </div>
                                <div class="ms-auto mt-md-0 mt-2"> <button class="btn btn-sm btn-secondary me-1"
                            ...
                            <div class="card-body">
                                <div class="row gy-3">
                                    ...
                                    <div class="col-xl-3">
                                        ...
                                        <p class="fs-15 mb-1">29,Nov 2022 - <span
                                                class="text-muted fs-12">12:42PM</span></p>
                                    </div>
                                    <div class="col-xl-3">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table nowrap text-nowrap border mt-4">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="fw-semibold"> Jimmy Lolfiger (Winter Coat)
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="text-muted"> Unisex jacket for men & women
                                                            </div>
                                                        </td>
                                                        <td class="product-quantity-container"> 1 </td>
                                                        <td> $499 </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="text-muted"> Light colored sweater form
                                                                blueberry </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="text-muted"> Flap pockets denim jackets for men
                                                            </div>
                                                        </td>
                                                        <td class="product-quantity-container"> 1 </td>
                                                        <td> $599 </td>
                                                            ...
                                                            <table
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <p class="mb-0 fw-semibold fs-15">$236.40
                                                                            </p>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <p class="mb-0 fw-semibold fs-15">$472.80
                                                                            </p>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <p
                                                                                class="mb-0 fw-semibold fs-16 text-success">
                                                                                $2,570.42</p>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                            ...
                            <div class="card-footer text-end"> <button class="btn btn-success">Download <i
                                        class="ri-download-2-line ms-1 align-middle"></i></button> </div>
                        </div>
                    </div>
                    <div class="col-xl-3">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-12">
                                        <p class="fs-14 fw-semibold"> Credit/Debit Card </p>
                                        <p> <span class="fw-semibold text-muted fs-12">Name On Card :</span> Json Taylor
                                        </p>
                                        <p> <span class="fw-semibold text-muted fs-12">Card Number :</span> 1234 5678
                                            9087 XXXX </p>
                                        <p> <span class="fw-semibold text-muted fs-12">Total Amount :</span> <span
                                                class="text-success fw-semibold fs-14">$2570.42</span> </p>
                                        <p> <span class="fw-semibold text-muted fs-12">Due Date :</span> 29,Dec 2022 -
                                            <span class="text-danger fs-12 fw-semibold">30 days due</span> </p>
