...
<body>
                        ...
                        <div class="row">
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <h4 class="mb-0 fw-semibold mb-2">109</h4> <span
                                                        class="badge bg-success-transparent">1.5% <i
                                                            class="ti ti-trending-up"></i></span><span
                                                        class="text-muted fs-11 ms-1">this month</span>
                                                </div>
                                                <div> <span class="avatar avatar-md bg-primary p-2"> <i
                                                            class="ti ti-file-check fs-20 op-7"></i> </span> </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="card custom-card">
                                            <div class="card-body d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <h4 class="mb-0 fw-semibold mb-2">18</h4> <span
                                                        class="badge bg-danger-transparent">0.23% <i
                                                            class="ti ti-trending-down"></i></span><span
                                                        class="text-muted fs-11 ms-1">this month</span>
                                                </div>
                                                <div> <span class="avatar avatar-md bg-secondary p-2"> <i
                                                            class="ti ti-briefcase fs-20 op-7"></i> </span> </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="card custom-card">
                                            <div class="card-body d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <h4 class="mb-0 fw-semibold mb-2">389</h4> <span
                                                        class="badge bg-success-transparent">0.67% <i
                                                            class="ti ti-trending-up"></i></span><span
                                                        class="text-muted fs-11 ms-1">this month</span>
                                                </div>
                                                <div> <span class="avatar avatar-md bg-success p-2"> <i
                                                            class="ti ti-album fs-20 op-7"></i> </span> </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="card custom-card">
                                            <div class="card-body d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <h4 class="mb-0 fw-semibold mb-2">227</h4> <span
                                                        class="badge bg-success-transparent">0.53% <i
                                                            class="ti ti-trending-up"></i></span><span
                                                        class="text-muted fs-11 ms-1">this month</span>
                                                </div>
                                                <div> <span class="avatar avatar-md bg-warning p-2"> <i
                                                            class="ti ti-chart-pie-2 fs-20 op-7"></i> </span> </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
                                        <div class="card custom-card">
                                            <div class="card-header justify-content-between">
                                                ...
                                                <div class="dropdown"> <a href="javascript:void(0);"
                                                        class="p-2 fs-12 text-muted" data-bs-toggle="dropdown"> View
                                                        All<i
                                                ...
                                                <ul class="list-unstyled team-members-card mb-0">
                                                    <li> <a href="javascript:void(0)">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-top"> <span
                                                                        class="avatar avatar-sm lh-1"> <img
                                                                            src="../assets/images/faces/2.jpg" alt="">
                                                                    </span>
                                                                    <div class="ms-3 lh-1"> <span
                                                                            class="fw-semibold">Melissa Smith</span>
                                                                        <span class="d-block fs-11 text-muted mt-2">Ui
                                                                            Developer</span> </div>
                                                                </div>
                                                                <div id="user1"></div>
                                                            </div>
                                                    ...
                                                    <li> <a href="javascript:void(0)">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-top"> <span
                                                                    ...
                                                                    <div class="ms-3 lh-1"> <span
                                                                            class="fw-semibold">Jason Momoa</span> <span
                                                                            class="d-block fs-11 text-muted mt-2">React
                                                                            Developer</span> </div>
                                                                </div>
                                                                <div id="user2"></div>
                                                            </div>
                                                    ...
                                                    <li> <a href="javascript:void(0)">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-top"> <span
                                                                    ...
                                                                    <div class="ms-3 lh-1"> <span
                                                                            class="fw-semibold">Kamala Hars</span> <span
                                                                            class="d-block fs-11 text-muted mt-2">Testing</span>
                                                                    </div>
                                                                </div>
                                                                <div id="user3"></div>
                                                            </div>
                                                    ...
                                                    <li> <a href="javascript:void(0)">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-top"> <span
                                                                    ...
                                                                    <div class="ms-3 lh-1"> <span
                                                                            class="fw-semibold">Diego Sanch</span> <span
                                                                            class="d-block fs-11 text-muted mt-2">Angular
                                                                            Developer</span> </div>
                                                                </div>
                                                                <div id="user4"></div>
                                                            </div>
                                                    ...
                                                    <li> <a href="javascript:void(0)">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-top"> <span
                                                                    ...
                                                                    <div class="ms-3 lh-1"> <span
                                                                            class="fw-semibold">Jake Sully</span> <span
                                                                            class="d-block fs-11 text-muted mt-2">Web
                                                                            Designer</span> </div>
                                                                </div>
                                                                <div id="user5"></div>
                                                            </div>
                                                ...
                                                <ul class="list-unstyled projects-maintask-card">
                                                    <li>
                                                        <div class="d-flex align-items-top">
                                                            <div class="d-flex align-items-top flex-fill"> <span
                                                                    class="me-3"> <input class="form-check-input"
                                                                        type="checkbox" id="checkboxNoLabel1" value=""
                                                                        aria-label="..."> </span>
                                                                <div class="flex-fill"> <span> Designing a landing page
                                                                    </span> <span class="d-block mt-1"> <span
                                                                            class="avatar-list-stacked"> <span
                                                                                ...
                                                                                class="avatar avatar-xs avatar-rounded">
                                                                                <img src="../assets/images/faces/2.jpg"
                                                                                    alt="img"> </span> </span> </span>
                                                                </div>
                                                            </div>
                                                            <div> <span class="badge bg-primary-transparent"> In
                                                                    progress </span> </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="d-flex align-items-top">
                                                            <div class="d-flex align-items-top flex-fill"> <span
                                                                    class="me-3"> <input class="form-check-input"
                                                                        ...
                                                                        aria-label="..." checked> </span>
                                                                <div class="flex-fill"> <span> Testing of new project ui
                                                                    </span> <span class="d-block mt-1"> <span
                                                                            class="avatar-list-stacked"> <span
                                                                                class="avatar avatar-xs avatar-rounded">
                                                            ...
                                                            <div> <span class="badge bg-success-transparent"> Completed
                                                                </span> </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="d-flex align-items-top">
                                                            <div class="d-flex align-items-top flex-fill"> <span
                                                                    class="me-3"> <input class="form-check-input"
                                                                        ...
                                                                        aria-label="..."> </span>
                                                                <div class="flex-fill"> <span> Fixing bugs in
                                                                        registration page </span> <span
                                                                        class="d-block mt-1"> <span
                                                                            class="avatar-list-stacked"> <span
                                                                                class="avatar avatar-xs avatar-rounded">
                                                            ...
                                                            <div> <span class="badge bg-warning-transparent"> pending
                                                                </span> </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="d-flex align-items-top">
                                                            <div class="d-flex align-items-top flex-fill"> <span
                                                                    class="me-3"> <input class="form-check-input"
                                                                        ...
                                                                        aria-label="..." checked> </span>
                                                                <div class="flex-fill"> <span> Designing new dashboard
                                                                    </span> <span class="d-block mt-1"> <span
                                                                            class="avatar-list-stacked"> <span
                                                                                class="avatar avatar-xs avatar-rounded">
                                                                                <img src="../assets/images/faces/10.jpg"
                            ...
                            <div class="col-xxl-3">
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-unstyled daily-task-card my-2">
                                            <li>
                                                <div
                                                    class="card border border-primary border-opacity-25 shadow-none custom-card mb-0">
                                                    <div class="card-body">
                                                        <p class="fs-14 fw-semibold mb-2 lh-1">Home Page Design <a
                                                                aria-label="anchor" href="javascript:void(0);"><i
                                                                    class="bi bi-plus-square float-end text-primary fs-18"></i></a>
                                                        </p>
                                                        <div class="d-flex flex-wrap gap-2 mb-4"> <span
                                                                class="badge bg-primary-transparent">Framework</span>
                                                            <span class="badge bg-secondary-transparent">Angular</span>
                                                            <span class="badge bg-info-transparent">Php</span> </div>
                                                        <div class="avatar-list-stacked"> <span
                                                                class="avatar avatar-sm avatar-rounded"> <img
                                                                    src="../assets/images/faces/2.jpg" alt="img">
                                                            </span> <span class="avatar avatar-sm avatar-rounded"> <img
                                            ...
                                            <li>
                                                <div
                                                    class="card border border-warning border-opacity-25 shadow-none custom-card">
                                                    <div class="card-body">
                                                        <p class="fs-14 fw-semibold mb-2 lh-1">About Us Page redesign <a
                                                                aria-label="anchor" href="javascript:void(0);"><i
                                                                    class="bi bi-plus-square float-end text-warning fs-18"></i></a>
                                                        </p>
                                                        <div class="d-flex flex-wrap gap-2 mb-4"> <span
                                                                class="badge bg-danger-transparent">Html</span> <span
                                                                class="badge bg-warning-transparent">Symphony</span>
                                                            <span class="badge bg-success-transparent">Php</span> </div>
                                                        <div class="avatar-list-stacked"> <span
                                                                class="avatar avatar-sm avatar-rounded"> <img
                                            ...
                                            <li>
                                                <div
                                                    class="card border border-success border-opacity-25 shadow-none custom-card">
                                                    <div class="card-body">
                                                        <p class="fs-14 fw-semibold mb-2 lh-1">About Us Page redesign <a
                                                                aria-label="anchor" href="javascript:void(0);"><i
                                                                    class="bi bi-plus-square float-end text-success fs-18"></i></a>
                                                        </p>
                                                        <div class="d-flex flex-wrap gap-2 mb-4"> <span
                                                                class="badge bg-danger-transparent">Html</span> <span
                                                                class="badge bg-warning-transparent">Symphony</span>
                                            ...
                                            <li>
                                                <div
                                                    class="card border border-secondary border-opacity-25 shadow-none custom-card">
                                                    <div class="card-body">
                                                        <p class="fs-14 fw-semibold mb-2 lh-1">New Project Discussion <a
                                                                aria-label="anchor" href="javascript:void(0);"><i
                                                                    class="bi bi-plus-square float-end text-secondary fs-18"></i></a>
                                                        </p>
                                                        <div class="d-flex flex-wrap gap-2 mb-4"> <span
                                                                class="badge bg-info-transparent">React</span> <span
                                                                class="badge bg-primary-transparent">Typescript</span>
                                                        </div>
                                                        <div class="avatar-list-stacked"> <span
                                                                class="avatar avatar-sm avatar-rounded"> <img
                    ...
                    <div class="col-xxl-3">
                        <div class="row">
                            <div class="col-xxl-12">
                                <div
                                    class="card custom-card shadow-none projects-tracking-card overflow-hidden text-center">
                                    <div class="card-body"> <img
                                            src="https://spruko.com/demo/ynex/dist/assets/images/media/media-86.svg"
                                            alt="" class="mb-1">
                                        <div> <span class="fs-15 fw-semibold d-block mt-4 mb-3">Track your work progress
                                                here</span> <button type="button"
                                                class="btn btn-primary btn-sm btn-wave">Track Here</button> </div> <span
                                            class="shape-1 text-primary"><i
                                                class="ti ti-circle fs-20 fw-bold"></i></span> <span
                                            class="shape-2 text-secondary"><i
                                                class="ti ti-triangle fs-20 fw-bold"></i></span> <span
                                            class="shape-3 text-warning"><i
                                                class="ti ti-square fs-20 fw-bold"></i></span> <span
                                            class="shape-4 text-info"><i
                                                class="ti ti-square-rotated fs-20 fw-bold"></i></span> <span
                                            class="shape-5 text-success"><i
                                                class="ti ti-pentagon fs-20 fw-bold"></i></span> <span
                                            class="shape-6 text-danger"><i class="ti ti-star fs-20 fw-bold"></i></span>
                                        <span class="shape-7 text-pink"><i
                                                class="ti ti-hexagon fs-20 fw-bold"></i></span> <span
                                            class="shape-8 text-teal"><i class="ti ti-octagon fs-20 fw-bold"></i></span>
                                        <span class="shape-9 text-primary"><i
                                                class="ti ti-circle fs-20 fw-bold"></i></span> <span
                                            class="shape-10 text-secondary"><i
                                                class="ti ti-triangle fs-20 fw-bold"></i></span> <span
                                            class="shape-11 text-warning"><i
                                                class="ti ti-square fs-20 fw-bold"></i></span> <span
                                            class="shape-12 text-info"><i
                                                class="ti ti-square-rotated fs-20 fw-bold"></i></span> <span
                                            class="shape-13 text-success"><i
                                                class="ti ti-pentagon fs-20 fw-bold"></i></span> <span
                                            class="shape-14 text-danger"><i class="ti ti-star fs-20 fw-bold"></i></span>
                                        <span class="shape-15 text-pink"><i
                                                class="ti ti-hexagon fs-20 fw-bold"></i></span> <span
                                            class="shape-16 text-teal"><i
                                                class="ti ti-octagon fs-20 fw-bold"></i></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-12">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-unstyled project-transactions-card">
                                            <li>
                                                <div class="d-flex align-items-top">
                                                    <div class="me-3"> <span
                                                            class="avatar avatar-rounded fw-bold avatar-md bg-primary-transparent">
                                                            S </span> </div>
                                                    <div class="flex-fill"> <span class="d-block fw-semibold">Simon
                                                            Cowall</span> <span class="d-block text-muted fs-11">Feb
                                                            28,2023 - 12:54PM</span> </div>
                                                    <div>
                                            ...
                                            <li>
                                                <div class="d-flex align-items-top">
                                                    <div class="me-3"> <span
                                                            class="avatar avatar-rounded fw-bold avatar-md bg-secondary-transparent">
                                                            M </span> </div>
                                                    <div class="flex-fill"> <span class="d-block fw-semibold">Melissa
                                                            Blue</span> <span class="d-block text-muted fs-11">Mar
                                                            28,2023 - 10:14AM</span> </div>
                                                    <div>
                                            ...
                                            <li>
                                                <div class="d-flex align-items-top">
                                                    <div class="me-3"> <span
                                                            class="avatar avatar-rounded fw-bold avatar-md bg-success-transparent">
                                                            G </span> </div>
                                                    <div class="flex-fill"> <span class="d-block fw-semibold">Gabriel
                                                            Shin</span> <span class="d-block text-muted fs-11">Mar
                                                            16,2023 - 05:27PM</span> </div>
                                                    <div>
                                            ...
                                            <li>
                                                <div class="d-flex align-items-top">
                                                    <div class="me-3"> <span
                                                            class="avatar avatar-rounded fw-bold avatar-md bg-warning-transparent">
                                                            Y </span> </div>
                                                    <div class="flex-fill"> <span class="d-block fw-semibold">Yohasimi
                                                            Nakiyaro</span> <span class="d-block text-muted fs-11">Mar
                                                            19,2023 - 04:45PM</span> </div>
                                                    <div>
                                            ...
                                            <li>
                                                <div class="d-flex align-items-top">
                                                    <div class="me-3"> <span
                                                            class="avatar avatar-rounded fw-bold avatar-md bg-info-transparent">
                                                            B </span> </div>
                                                    <div class="flex-fill"> <span class="d-block fw-semibold">Brenda
                                                            Lynn</span> <span class="d-block text-muted fs-11">Mar
                                                            10,2023 - 05:25PM</span> </div>
                                                    <div>
                        ...
                        <div class="card custom-card">
                            <div class="card-header justify-content-between">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="dropdown my-1"> <a href="javascript:void(0);"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="avatar-list-stacked"> <span
                                                        ...
                                                        <span class="avatar avatar-xs avatar-rounded"> <img
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="avatar-list-stacked"> <span
                                                        ...
                                                        <span class="avatar avatar-xs avatar-rounded"> <img
                                                                src="../assets/images/faces/4.jpg" alt="img"> </span> <a
                                                            class="avatar avatar-xs bg-primary avatar-rounded text-fixed-white"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="avatar-list-stacked"> <span
                                                        ...
                                                        <a class="avatar avatar-xs bg-primary avatar-rounded text-fixed-white"
                                                ...
                                                <td>
                                                    <div class="avatar-list-stacked"> <span
                                                            class="avatar avatar-xs avatar-rounded"> <img
                                                                src="../assets/images/faces/4.jpg" alt="img"> </span>
                                                        <span class="avatar avatar-xs avatar-rounded"> <img
                                                                src="../assets/images/faces/7.jpg" alt="img"> </span>
                                                        <span class="avatar avatar-xs avatar-rounded"> <img
    ...
    <script src="../assets/libs/moment/moment.js"></script> <!-- Projects-Dashboard JS -->
    <script src="../assets/js/projects-dashboard.js"></script> <!-- Custom-Switcher JS -->
    <script src="../assets/js/custom-switcher.min.js"></script> <!-- Custom JS -->
    <script src="../assets/js/custom.js"></script>
</body>
<!-- Mirrored from spruko.com/demo/ynex/dist/html/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Jun 2023 07:35:21 GMT -->
