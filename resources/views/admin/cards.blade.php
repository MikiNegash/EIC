        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Richard McClintock, a Latin professor at Hampden-Sydney College in
                                    ...
                                    Ipsum passage</p><a href="javascript:void(0);" class="btn btn-primary">Read More</a>
                            </div>
                        </div>
                        <div class="card custom-card">
                            <div class="card-body">
                            ...
                            <div class="card-footer"> <a href="javascript:void(0);"
                                    class="card-link text-danger m-1">Buy Now</a> <a href="javascript:void(0);"
                                    class="card-link text-success m-1"><u>Review</u></a> </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card custom-card"> <img src="../assets/images/media/media-23.jpg"
                                class="card-img-top" alt="...">
                            <div class="card-body">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card custom-card"> <img src="../assets/images/media/media-24.jpg"
                                class="card-img-top" alt="...">
                            <div class="card-body">
                                <h6 class="card-title fw-semibold">Card title</h6>
                                <p class="card-text">Some quick example text to build on the card title and make up the
                            ...
                            <div class="card-body"> <a href="javascript:void(0);" class="card-link text-primary">Card
                                    link</a> <a href="javascript:void(0);"
                                    class="card-link text-secondary d-inline-block">Another link</a> </div>
                        </div>
                    </div>
                </div> <!-- End::row-1 -->
                <!-- Start::row-2 -->
                <div class="row">
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <blockquote class="blockquote mb-0 text-center">
                                            <h6>The greatest glory in living lies not in never falling, but in rising
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-12">
                        ...
                        <div class="row row-cols-12">
                            <div class="col">
                                <div class="card custom-card">
                                    <div class="card-body"> <img src="../assets/images/media/media-25.jpg"
                            ...
                            <div class="col">
                                <div class="card custom-card">
                                    <div class="card-body"> <img src="../assets/images/media/media-26.jpg"
                                            class="card-img mb-3" alt="...">
                                        <h6 class="card-title fw-semibold">Product B</h6>
                                        <p class="card-text">With supporting text below as a natural lead-in to
                                            additional content.</p><a href="javascript:void(0);"
                                            class="btn btn-secondary">Purchase</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card custom-card">
                                    <div class="card-body"> <img src="../assets/images/media/media-27.jpg"
                                            class="card-img mb-3" alt="...">
                                        <h6 class="card-title fw-semibold">Product-C</h6>
                                        <p class="card-text">With supporting text below as a natural lead-in to
                                            additional content.</p><a href="javascript:void(0);"
                                            class="btn btn-light">Purchase</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div class="mb-2"> <span class="avatar avatar-md"> <img
                                        ...
                                        <p class="card-text">Contrary to popular belief, Lorem Ipsum is not simply
                                            random text. It has roots in a piece of classical Latin literature.</p><a
                                            href="javascript:void(0);" class="btn btn-primary">Go somewhere</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4">
                                <div class="card text-center custom-card">
                                    <div class="card-body">
                                        <div class="mb-2"> <span class="avatar avatar-md"> <img
                                                    src="../assets/images/faces/3.jpg" alt="img"> </span> </div>
                                        ...
                                        <p class="card-text">Many desktop publishing packages and web page editors now
                                            use Lorem Ipsum as their default model text.</p><a
                                            href="javascript:void(0);" class="btn btn-primary">Go somewhere</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                        ...
                        <div class="card custom-card">
                            <div class="card-header">
                                <div class="d-flex align-items-center w-100">
                                    ...
                                    <div class="dropdown ms-auto"> <a href="javascript:void(0);"
                            ...
                            <div class="card-body"> If you are going to use, you need to be sure there isn't anything
                    ...
                    <div class="col-xl-3">
                        <div class="card custom-card">
                            <div class="card-header border-bottom-0 pb-0">
                                <div> <span class="text-warning me-1"><i class="bi bi-star-fill"></i></span> <span
                                        class="text-warning me-1"><i class="bi bi-star-fill"></i></span> <span
                                        class="text-warning me-1"><i class="bi bi-star-fill"></i></span> <span
                                        class="text-warning me-1"><i class="bi bi-star-fill"></i></span> <span
                                        class="text-black op-1"><i class="bi bi-star-fill"></i></span>
                                    <p class="d-block text-muted mb-0 fs-12 fw-semibold">1 year ago</p>
                                </div>
                            </div>
                            <div class="card-body pt-3">
                                <div class="fw-semibold fs-15 mb-2">Very Great!</div> There are many variations of
                            ...
                            <div class="card-footer">
                                <div class="d-flex align-items-center"> <span
                                        class="avatar avatar-sm avatar-rounded me-2"> <img
                                            src="../assets/images/faces/12.jpg" alt="img"> </span>
                    ...
                    <div class="col-xl-3">
                        <div class="card custom-card text-center">
                            <div class="card-header border-bottom-0 pb-0"> <span class="ms-auto shadow-lg fs-17"><i
                                        class="ri-heart-fill text-danger"></i></span> </div>
                            <div class="card-body pt-1"> <span class="avatar avatar-xl avatar-rounded me-2 mb-2"> <img
                                ...
                                <div class="btn-list"> <button class="btn btn-icon btn-facebook btn-wave"> <i
                                        ...
                                        class="btn btn-icon btn-twitter btn-wave"> <i class="ri-twitter-line"></i>
                                            ...
                                            class="ri-instagram-line"></i> </button> </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3">
                        <div class="card custom-card border border-primary">
                            <div class="card-body"> <svg class="footer-card-icon my-3"
                            ...
                            <div class="card-footer"> Lorem Ipsum is therefore always free from repetition, injected
                                humour. </div>
                        </div>
                    </div>
                    <div class="col-xl-2">
                        <div class="card custom-card">
                            <div class="card-body"> <img src="../assets/images/media/media-4.jpg" class="card-img mb-3"
                                    alt="...">
                    ...
                    <div class="col-xl-2">
                        <div class="card custom-card">
                            <div class="card-body"> <img src="../assets/images/media/media-9.jpg" class="card-img mb-3"
                                    alt="...">
                    ...
                    <div class="col-xl-2">
                        <div class="card custom-card">
                            <div class="card-body"> <img src="../assets/images/media/media-15.jpg" class="card-img mb-3"
                                    alt="...">
                    ...
                    <div class="col-xl-3">
                        <div class="card custom-card text-center">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text mb-4">With supporting text below as a natural lead-in to additional
                                    content.</p><a href="javascript:void(0);" class="btn btn-primary mt-2">Read More</a>
                        ...
                        <div class="card custom-card">
                            <div class="card-header">
                                <div class="d-flex w-100">
                                    <div class="me-4"> <span class="avatar avatar-lg avatar-rounded"> <img
                                                src="../assets/images/faces/12.jpg" alt="img"> </span> </div>
                                ...
                                <div class="card custom-card w-75">
                                    ...
                                    <div class="card-body">
                                        <div class="card-text"> Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                            Id nostrum omnis excepturi consequatur molestiae </div>
                                    </div>
                                    <div class="card-footer"> <a href="javascript:void(0);"
                                            class="btn btn-primary d-grid">Button</a> </div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                ...
                                <div class="card custom-card text-center">
                                    <div class="card-header">
                                        <ul class="nav nav-tabs card-header-tabs ms-1">
                                            <li class="nav-item"> <a class="nav-link active" aria-current="true"
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="card custom-card"> <img src="../assets/images/media/media-29.jpg"
                                class="card-img-top" alt="...">
                            <div class="card-body">
                    ...
                    <div class="col-xl-4">
                        <div class="card custom-card">
                            <div class="card-body">
                                ...
                                <p class="card-text mb-0"><small>Last updated 3 mins ago</small></p>
                            </div> <img src="../assets/images/media/media-28.jpg" class="card-img-bottom" alt="...">
                        </div>
                    </div>
                    <div class="col-xl-4">
                        <div class="card custom-card">
                            ...
                            </div> <img src="../assets/images/media/media-30.jpg" class="card-img rounded-0" alt="...">
                            <div class="card-body">
                                <p class="card-text mb-0"><small>Last updated 3 mins ago</small></p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <p class="card-text mb-1 text-muted">This is a wider card with supporting text below as
                                    a natural lead-in to additional content. This content is a little bit longer.</p>
                            </div> <img src="../assets/images/media/media-31.jpg" class="card-img rounded-0" alt="...">
                            <div class="card-footer">
                                <p class="card-text mb-0"><small>Last updated 3 mins ago</small></p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4">
                        <div class="card custom-card">
                            ...
                            <div class="card-footer">
                                <p class="card-text mb-0"><small>Last updated 3 mins ago</small></p>
                            </div> <img src="../assets/images/media/media-33.jpg" class="card-img-bottom" alt="...">
                        </div>
                    </div>
                </div> <!-- End::row-6 -->
                <!-- Start::row-7 -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        <div class="card custom-card bg-dark overlay-card"> <img
                                src="../assets/images/media/media-34.jpg" class="card-img" alt="...">
                            <div class="card-img-overlay d-flex flex-column p-0">
                                <div class="card-header">
                                    <div class="card-title text-fixed-white"> Image Overlays Are Awesome! </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="card custom-card">
                            <div class="row g-0">
                                <div class="col-md-4"> <img src="../assets/images/media/media-37.jpg"
                                        class="img-fluid rounded-start h-100 w-100" alt="..."> </div>
                                <div class="col-md-8">
                                    <div class="card-header">
                    ...
                    <div class="col-xl-4">
                        <div class="card custom-card">
                            <div class="row g-0">
                                ...
                                <div class="col-md-4"> <img src="../assets/images/media/media-38.jpg"
                    ...
                    <div class="col-xl-4">
                        <div class="card custom-card">
                            <div class="row g-0">
                                ...
                                <div class="col-md-4"> <img src="../assets/images/media/media-39.jpg"
                                        class="img-fluid rounded-end h-100 w-100" alt="..."> </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card custom-card card-bg-primary">
                            <div class="card-body">
                                <div class="d-flex align-items-center w-100">
                                    ...
                                    <div class="ms-auto"> <a href="javascript:void(0);" class="text-fixed-white"><i
                                                class="bi bi-three-dots-vertical"></i></a> </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3">
                        <div class="card custom-card card-bg-warning">
                            <div class="card-body">
                                <div class="d-flex align-items-center w-100">
                                    <div class="me-2"> <span class="avatar avatar-rounded"> <img
                                                src="../assets/images/faces/1.jpg" alt="img"> </span> </div>
                                    <div class="">
                    ...
                    <div class="col-xl-3">
                        <div class="card custom-card card-bg-danger">
                            <div class="card-body">
                                <div class="d-flex align-items-center w-100">
                                    <div class="me-2"> <span class="avatar avatar-rounded"> <img
                                                src="../assets/images/faces/14.jpg" alt="img"> </span> </div>
                                    <div class="">
                    ...
                    <div class="col-xl-3">
                        <div class="card custom-card card-bg-light">
                            <div class="card-body">
                                <div class="d-flex align-items-center w-100">
                                    <div class="me-2"> <span class="avatar avatar-rounded"> <img
                                                src="../assets/images/faces/13.jpg" alt="img"> </span> </div>
                                    <div class="">
                                        <div class="fs-15 fw-semibold">Jacob Smith</div>
                                        <p class="mb-0 text-muted op-7 fs-12">Finished by 24,Nov</p>
                                    </div>
                                    <div class="ms-auto"> <a href="javascript:void(0);" class="text-default"><i
                                                class="bi bi-three-dots-vertical"></i></a> </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3">
                        <div class="card custom-card card-bg-dark">
                            <div class="card-body">
                                <div class="d-flex align-items-center w-100">
                                    <div class="me-2"> <span class="avatar avatar-rounded"> <img
                                                src="../assets/images/faces/16.jpg" alt="img"> </span> </div>
                                    <div class="">
                ...
                <div class="row">
                    <div class="col-xl-3">
                        <div class="card border border-primary custom-card">
                            <div class="card-body">
                                <p class="fs-14 fw-semibold mb-2 lh-1">Home Page Design <a href="javascript:void(0);"><i
                                            class="bi bi-plus-square float-end text-primary fs-18"></i></a> </p>
                                <div class="d-flex flex-wrap gap-2 mb-4"> <span
                                        class="badge bg-primary-transparent">Framework</span> <span
                                        class="badge bg-secondary-transparent">Angular</span> <span
                                        class="badge bg-info-transparent">Php</span> </div>
                                <div class="avatar-list-stacked"> <span class="avatar avatar-sm avatar-rounded"> <img
                                            src="../assets/images/faces/2.jpg" alt="img"> </span> <span
                                        class="avatar avatar-sm avatar-rounded"> <img src="../assets/images/faces/8.jpg"
                                            alt="img"> </span> <span class="avatar avatar-sm avatar-rounded"> <img
                                            src="../assets/images/faces/2.jpg" alt="img"> </span> </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3">
                        <div class="card border border-secondary custom-card">
                            <div class="card-body">
                                <p class="fs-14 fw-semibold mb-2 lh-1">Landing Page Design <a
                                        href="javascript:void(0);"><i
                                            class="bi bi-plus-square float-end text-secondary fs-18"></i></a> </p>
                                <div class="d-flex flex-wrap gap-2 mb-4"> <span
                                        class="badge bg-danger-transparent">Laravel</span> <span
                                        class="badge bg-teal-transparent">Codeignitor</span> <span
                                        class="badge bg-success-transparent">Php</span> </div>
                                <div class="avatar-list-stacked"> <span class="avatar avatar-sm avatar-rounded"> <img
                                            src="../assets/images/faces/4.jpg" alt="img"> </span> <span
                                        class="avatar avatar-sm avatar-rounded"> <img src="../assets/images/faces/6.jpg"
                                            alt="img"> </span> </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3">
                        <div class="card border border-warning custom-card">
                            <div class="card-body">
                                <p class="fs-14 fw-semibold mb-2 lh-1">Update New Project <a
                                        href="javascript:void(0);"><i
                                            class="bi bi-plus-square float-end text-warning fs-18"></i></a> </p>
                                <div class="d-flex flex-wrap gap-2 mb-4"> <span
                                        class="badge bg-warning-transparent">Html</span> <span
                                        class="badge bg-secondary-transparent">Bootstrap</span> <span
                                        class="badge bg-info-transparent">React</span> </div>
                                <div class="avatar-list-stacked"> <span class="avatar avatar-sm avatar-rounded"> <img
                    ...
                    <div class="col-xl-3">
                        <div class="card border border-info custom-card">
                            <div class="card-body">
                                <p class="fs-14 fw-semibold mb-2 lh-1">New Project Discussion <a
                                        href="javascript:void(0);"><i
                                            class="bi bi-plus-square float-end text-info fs-18"></i></a> </p>
                                <div class="d-flex flex-wrap gap-2 mb-4"> <span
                                        class="badge bg-info-transparent">React</span> <span
                                        class="badge bg-primary-transparent">Typescript</span> </div>
                                <div class="avatar-list-stacked"> <span class="avatar avatar-sm avatar-rounded"> <img
                    ...
                    <div class="col-xl-3">
                        <div class="card border border-danger custom-card">
                            <div class="card-body">
                                <p class="fs-14 fw-semibold mb-2 lh-1">Recent Projects Testing <a
                                        href="javascript:void(0);"><i
                                            class="bi bi-plus-square float-end text-danger fs-18"></i></a> </p>
                                <div class="d-flex flex-wrap gap-2 mb-4"> <span
                                        class="badge bg-primary-transparent">Ui</span> <span
                                        class="badge bg-secondary-transparent">Angular</span> <span
                                        class="badge bg-info-transparent">Java</span> </div>
                                <div class="avatar-list-stacked"> <span class="avatar avatar-sm avatar-rounded"> <img
                                            src="../assets/images/faces/15.jpg" alt="img"> </span> </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3">
                        <div class="card border border-success custom-card">
                            <div class="card-body">
                                <p class="fs-14 fw-semibold mb-2 lh-1">About Us Page redesign <a
                                        href="javascript:void(0);"><i
                                            class="bi bi-plus-square float-end text-success fs-18"></i></a> </p>
                                <div class="d-flex flex-wrap gap-2 mb-4"> <span
                                        class="badge bg-danger-transparent">Html</span> <span
                                        class="badge bg-warning-transparent">Symphony</span> <span
                                        class="badge bg-success-transparent">Php</span> </div>
                                <div class="avatar-list-stacked"> <span class="avatar avatar-sm avatar-rounded"> <img
                                            src="../assets/images/faces/6.jpg" alt="img"> </span> <span
                                        class="avatar avatar-sm avatar-rounded"> <img src="../assets/images/faces/9.jpg"
                                            alt="img"> </span> </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3">
                        <div class="card border border-light custom-card">
                            <div class="card-body">
                                <p class="fs-14 fw-semibold mb-2 lh-1">New Employees <a href="javascript:void(0);"><i
                                            class="bi bi-plus-square float-end text-default fs-18"></i></a> </p>
                                <div class="d-flex flex-wrap gap-2 mb-4"> <span
                                        class="badge bg-warning-transparent">Html</span> <span
                                        class="badge bg-info-transparent">Cake Php</span> <span
                                        class="badge bg-success-transparent">React</span> </div>
                                <div class="avatar-list-stacked"> <span class="avatar avatar-sm avatar-rounded"> <img
                    ...
                    <div class="col-xl-3">
                        <div class="card border border-dark custom-card">
                            <div class="card-body">
                                <p class="fs-14 fw-semibold mb-2 lh-1">Terminated Employees <a
                                        href="javascript:void(0);"><i
                                            class="bi bi-plus-square float-end text-dark fs-18"></i></a> </p>
                                <div class="d-flex flex-wrap gap-2 mb-4"> <span
                                        class="badge bg-primary-transparent">Angular</span> </div>
                                <div class="avatar-list-stacked"> <span class="avatar avatar-sm avatar-rounded"> <img
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card-group">
                            <div class="card custom-card"> <img src="../assets/images/media/media-40.jpg"
                                    class="card-img-top" alt="...">
                                <div class="card-body">
                            ...
                            <div class="card custom-card"> <img src="../assets/images/media/media-41.jpg"
                                    class="card-img-top" alt="...">
                                <div class="card-body">
                            ...
                            <div class="card custom-card"> <img src="../assets/images/media/media-42.jpg"
                                    class="card-img-top" alt="...">
                                <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xxl-3 col-xl-12">
                        <div class="card custom-card"> <a href="javascript:void(0);" class="card-anchor"></a> <img
                                src="../assets/images/media/media-23.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-xxl-12 col-xl-12">
                                <div class="card custom-card card-bg-primary"> <a href="javascript:void(0);"
                                    ...
                                    <div class="card-body">
                                        <blockquote class="blockquote mb-0 text-center">
                                            <h6>The best and most beautiful things in the world cannot be seen or even
                                    ...
                                    <div class="row g-0">
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                ...
                                                <p class="mb-0 card-text"> Fox lives mainly in forests and are well
                                                    known for their hunting skills. </p>
                                            </div>
                                            <div class="card-footer">
                                        ...
                                        <div class="col-md-4"> <img src="../assets/images/media/media-39.jpg"
                                                class="img-fluid rounded-end h-100" alt="..."> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xxl-3 col-xl-6">
                        <div class="card custom-card"> <a href="javascript:void(0);" class="card-anchor"></a> <img
                                src="../assets/images/media/media-47.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="row row-cols-1 row-cols-md-4 g-4">
                            <div class="col">
                                <div class="card custom-card"> <img src="../assets/images/media/media-44.jpg"
                                        class="card-img-top" alt="...">
                                    <div class="card-body">
                            ...
                            <div class="col">
                                <div class="card custom-card"> <img src="../assets/images/media/media-43.jpg"
                                        class="card-img-top" alt="...">
                                    <div class="card-body">
                            ...
                            <div class="col">
                                <div class="card custom-card"> <img src="../assets/images/media/media-45.jpg"
                                        class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h6 class="card-title fw-semibold">Most tropical areas are suitable</h6>
                                        <p class="card-text"> If you are going to use a passage of Lorem Ipsum, you need
                            ...
                            <div class="col">
                                <div class="card custom-card"> <img src="../assets/images/media/media-46.jpg"
                                        class="card-img-top" alt="...">
                                    <div class="card-body">
