                    ...
                    <div class="col-lg-12 col-sm-6">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="row row-cols-12 d-flex align-items-center">
                                    <div class="p-3 col">
                                        <div class="m-2 bg-primary-transparent mx-auto color-container shadow-none">
                                        </div>
                                        <p class="pb-0 mb-0 fw-semibold text-center">
                                            <code>.bg-primary-transparent</code></p>
                                    </div>
                                    <div class="p-3 col">
                                        <div class="m-2 bg-secondary-transparent mx-auto color-container shadow-none">
                                        </div>
                                        <p class="pb-0 mb-0 fw-semibold text-center">
                                            <code>.bg-secondary-transparent</code></p>
                                    </div>
                                    <div class="p-3 col">
                                        <div class="m-2 bg-warning-transparent mx-auto color-container shadow-none">
                                        </div>
                                        <p class="pb-0 mb-0 fw-semibold text-center">
                                            <code>.bg-warning-transparent</code></p>
                                    </div>
                                    <div class="p-3 col">
                                    ...
                                    <div class="p-3 col">
                                        <div class="m-2 bg-success-transparent mx-auto color-container shadow-none">
                                        </div>
                                        <p class="pb-0 mb-0 fw-semibold text-center">
                                            <code>.bg-success-transparent</code></p>
                                    </div>
                                    <div class="p-3 col">
                                        <div class="m-2 bg-danger-transparent mx-auto color-container shadow-none">
                                        </div>
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="row row-cols-12 d-flex align-items-center">
                                    ...
                                    <div class="p-3 col">
                                        <div class="m-2 bg-outline-info mx-auto color-container"><i
                                                class="bi bi-emoji-smile fs-18"></i></div>
                                    ...
                                    <div class="p-3 col">
                                        <div class="m-2 bg-outline-dark mx-auto color-container"><i
                                                class="bi bi-emoji-smile fs-18"></i></div>
                            ...
                            <div class="col-xl-12">
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        <div class="row row-cols-12 d-flex align-items-center">
                                            <div class="p-3 col">
                                                <div class="m-2 text-primary fw-semibold fs-14 text-center">Opacity-100
                                                </div>
                                                <p class="pb-0 mb-0 fw-semibold text-center"><code>100% opacity</code>
                                                </p>
                                            </div>
                                            <div class="p-3 col">
                                                <div
