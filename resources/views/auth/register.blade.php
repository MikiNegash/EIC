    ...
    <div class="container-lg">
        <div class="row justify-content-center align-items-center authentication authentication-basic h-100">
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                <div class="my-5 d-flex justify-content-center">  <img src="logo.png" alt="logo"
                            class="desktop-logo"> <img src="logo.png" alt="logo" class="desktop-dark"> </a>
                </div>
...
<div class="input-group mb-3"> <input type="file" name="photo" class="form-control" required
        ...
        <div class="text-center">
            <p class="fs-12 text-muted mt-3">Already have an account? <a href="login" class="text-primary">Sign In</a>
            </p>
        </div>
